...
var $author$project$Pakeman$Model = function (console) {
	return {M: console};
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Pakeman$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Pakeman$Model(
			_List_fromArray(
				['test1', 'test2'])),
...
var $author$project$Pakeman$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Pakeman$update = F2(
	function (msg, model) {
...
var $author$project$Pakeman$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('w-25')
					]),
				_List_fromArray(
					[
						A2(
...
var $author$project$Pakeman$main = $elm$browser$Browser$element(
	{au: $author$project$Pakeman$init, aA: $author$project$Pakeman$subscriptions, aC: $author$project$Pakeman$update, aD: $author$project$Pakeman$view});
_Platform_export({'Pakeman':{'init':$author$project$Pakeman$main(
